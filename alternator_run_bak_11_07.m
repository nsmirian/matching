...
quads = {'QD.181.B1','QI.204.B1','QD.210.B1','QI.211.B1','QI.213.B1','QI.215.B1','QI.217.B1'}; %'QI.204.B1','QI.205.B1','QI.206.B1','QI.209.B1',  %'QD.181.B1','QI.204.B1',
...
for ii=1:iter
    ...
    for i=1:n
        out(i) = the_alternator_bak_11_07(m,refpos,k_start(i,:),twiss_in,twiss_goal,N,zlist);
